...
__global__ void fill_measurement_cluster_keys(
  ...
  device::fill_measurement_cluster_keys(details::global_index1(), measurements,
                                        keys, indices);
}
...
__global__ void gather_measurement_surface_keys(
  ...
  device::gather_measurement_surface_keys(details::global_index1(),
                                          measurements, indices, keys);
}
