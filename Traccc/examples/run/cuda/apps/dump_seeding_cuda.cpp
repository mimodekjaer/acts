...
// Validation helper: runs the CUDA "seeding stage" chain (clusterization,
...
int main(int argc, char* argv[]) {
  std::unique_ptr<const traccc::Logger> logger =
      traccc::getDefaultLogger("DumpSeedingCuda", traccc::Logging::Level::INFO);
  ...
  traccc::opts::program_options program_opts{
      "CUDA seeding-stage result dump",
  ...
  traccc::cuda::clusterization_algorithm ca(mr, copy, stream, clustering_cfg,
                                            logger->clone("CA"));
  traccc::cuda::measurement_sorting_algorithm ms(mr, copy, stream,
                                                 logger->clone("MS"));
